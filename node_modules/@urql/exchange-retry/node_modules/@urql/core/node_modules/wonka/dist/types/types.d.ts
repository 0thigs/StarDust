...
export declare type Start<_T> = Tag<SignalKind.Start> & [TalkbackFn];
/** The Push [Signal] carries new values to the sink, like in an event emitter */
export declare type Push<T> = Tag<SignalKind.Push> & [T];
/** A signal that communicates new events to a sink. */
export declare type Signal<T> = Start<T> | Push<T> | SignalKind.End;
...
export declare type Sink<T> = (signal: Signal<T>) => void;
/** A source is a function that accepts a [Sink] and then starts sending [Signal]s to it. */
export declare type Source<T> = (sink: Sink<T>) => void;
