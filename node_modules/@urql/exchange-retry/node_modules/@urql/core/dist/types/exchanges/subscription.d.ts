import { Exchange, ExecutionResult, Operation, OperationContext } from '../types';
...
export declare const subscriptionExchange: ({ forwardSubscription, enableAllOperations, isSubscriptionOperation, }: SubscriptionExchangeOpts) => Exchange;
