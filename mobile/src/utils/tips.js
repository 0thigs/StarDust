export const tips = [
    'Mantenha seu código organizado e limpo',
    'Use "var" para declarar uma nova variável',
    'Utilize o método inclui() para verificar se um elemento está presente em um vetor',
